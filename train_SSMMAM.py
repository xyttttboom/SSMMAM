...
import models.SE_ResNext as models
...
# Method options
parser.add_argument('--n-labeled', type=int, default=2,
...
def main():
    ...
    if args.retina:
        ...
        if args.test_mode:
            ...
            train_labeled_set, train_unlabeled_set, val_set = dataset.get_skinlesion_dataset("./data/lung/",
                                                        num_labels=args.n_labeled,
                                                        transform_train=transform_train,
                                                        transform_val=transform_val,
                                                         transform_forsemi=None)
            ...
            train_labeled_set, train_unlabeled_set, val_set, test_set = dataset.get_skinlesion_dataset("./data/lung/",
                                                        num_labels=args.n_labeled,
                                                        transform_train=transform_train,
                                                        transform_val=transform_val,
                                                         transform_forsemi=None)
...
def train_meanteacher(labeled_trainloader, unlabeled_trainloader, model, ema_model, optimizer,
    ...
    if args.consistency_type == 'mse': # 执行的这个
